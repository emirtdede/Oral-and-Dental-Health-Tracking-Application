...
namespace DisSagligiTakip.Migrations
{
    ...
    [Migration("20250831214949_Add_AppointmentFeature")]
    partial class Add_AppointmentFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DisSagligiTakip.Entities.MuayeneRandevusu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HastaUserId", "BaslangicZamani");

                    b.HasIndex("HekimUserId", "BaslangicZamani");

                    b.ToTable("MuayeneRandevulari");
                });
            ...
            modelBuilder.Entity("DisSagligiTakip.Entities.MuayeneRandevusu", b =>
                {
                    ...
                    b.HasOne("DisSagligiTakip.Entities.User", "Hekim")
                        .WithMany()
                        .HasForeignKey("HekimUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DisSagligiTakip.Entities.User", "Olusturan")
                        .WithMany()
